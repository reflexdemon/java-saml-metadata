package io.vpv.saml.metasaml.metadata.settings;
...
import io.vpv.saml.metasaml.metadata.exception.Error;
import io.vpv.saml.metasaml.metadata.model.Contact;
import io.vpv.saml.metasaml.metadata.model.KeyStoreSettings;
import io.vpv.saml.metasaml.metadata.model.Organization;
import io.vpv.saml.metasaml.metadata.util.Util;
import org.apache.commons.lang3.StringUtils;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * SettingsBuilder class of VPV Saml Tool
 *
...
public class SettingsBuilder {
	...
	public final static String STRICT_PROPERTY_KEY = "io.vpv.saml2.strict";
	public final static String DEBUG_PROPERTY_KEY = "io.vpv.saml2.debug";

	// SP
	public final static String SP_ENTITYID_PROPERTY_KEY = "io.vpv.saml2.sp.entityid";
	public final static String SP_ASSERTION_CONSUMER_SERVICE_URL_PROPERTY_KEY = "io.vpv.saml2.sp.assertion_consumer_service.url";
	public final static String SP_ASSERTION_CONSUMER_SERVICE_BINDING_PROPERTY_KEY = "io.vpv.saml2.sp.assertion_consumer_service.binding";
	public final static String SP_SINGLE_LOGOUT_SERVICE_URL_PROPERTY_KEY = "io.vpv.saml2.sp.single_logout_service.url";
	public final static String SP_SINGLE_LOGOUT_SERVICE_BINDING_PROPERTY_KEY = "io.vpv.saml2.sp.single_logout_service.binding";
	public final static String SP_NAMEIDFORMAT_PROPERTY_KEY = "io.vpv.saml2.sp.nameidformat";

	public final static String SP_X509CERT_PROPERTY_KEY = "io.vpv.saml2.sp.x509cert";
	public final static String SP_PRIVATEKEY_PROPERTY_KEY = "io.vpv.saml2.sp.privatekey";
	public final static String SP_X509CERTNEW_PROPERTY_KEY = "io.vpv.saml2.sp.x509certNew";

	// KeyStore
	public final static String KEYSTORE_KEY = "io.vpv.saml2.keystore.store";
	public final static String KEYSTORE_ALIAS = "io.vpv.saml2.keystore.alias";
	public final static String KEYSTORE_KEY_PASSWORD = "io.vpv.saml2.keystore.key.password";

	// IDP
	public final static String IDP_ENTITYID_PROPERTY_KEY = "io.vpv.saml2.idp.entityid";
	public final static String IDP_SINGLE_SIGN_ON_SERVICE_URL_PROPERTY_KEY = "io.vpv.saml2.idp.single_sign_on_service.url";
	public final static String IDP_SINGLE_SIGN_ON_SERVICE_BINDING_PROPERTY_KEY = "io.vpv.saml2.idp.single_sign_on_service.binding";
	public final static String IDP_SINGLE_LOGOUT_SERVICE_URL_PROPERTY_KEY = "io.vpv.saml2.idp.single_logout_service.url";
	public final static String IDP_SINGLE_LOGOUT_SERVICE_RESPONSE_URL_PROPERTY_KEY = "io.vpv.saml2.idp.single_logout_service.response.url";
	public final static String IDP_SINGLE_LOGOUT_SERVICE_BINDING_PROPERTY_KEY = "io.vpv.saml2.idp.single_logout_service.binding";

	public final static String IDP_X509CERT_PROPERTY_KEY = "io.vpv.saml2.idp.x509cert";
	public final static String IDP_X509CERTMULTI_PROPERTY_KEY = "io.vpv.saml2.idp.x509certMulti";
	public final static String CERTFINGERPRINT_PROPERTY_KEY = "io.vpv.saml2.idp.certfingerprint";
	public final static String CERTFINGERPRINT_ALGORITHM_PROPERTY_KEY = "io.vpv.saml2.idp.certfingerprint_algorithm";

	// Security
	public final static String SECURITY_NAMEID_ENCRYPTED = "io.vpv.saml2.security.nameid_encrypted";
	public final static String SECURITY_AUTHREQUEST_SIGNED = "io.vpv.saml2.security.authnrequest_signed";
	public final static String SECURITY_LOGOUTREQUEST_SIGNED = "io.vpv.saml2.security.logoutrequest_signed";
	public final static String SECURITY_LOGOUTRESPONSE_SIGNED = "io.vpv.saml2.security.logoutresponse_signed";
	public final static String SECURITY_WANT_MESSAGES_SIGNED = "io.vpv.saml2.security.want_messages_signed";
	public final static String SECURITY_WANT_ASSERTIONS_SIGNED = "io.vpv.saml2.security.want_assertions_signed";
	public final static String SECURITY_WANT_ASSERTIONS_ENCRYPTED = "io.vpv.saml2.security.want_assertions_encrypted";
	public final static String SECURITY_WANT_NAMEID = "io.vpv.saml2.security.want_nameid";
	public final static String SECURITY_WANT_NAMEID_ENCRYPTED = "io.vpv.saml2.security.want_nameid_encrypted";
	public final static String SECURITY_SIGN_METADATA = "io.vpv.saml2.security.sign_metadata";
	public final static String SECURITY_REQUESTED_AUTHNCONTEXT = "io.vpv.saml2.security.requested_authncontext";
	public final static String SECURITY_REQUESTED_AUTHNCONTEXTCOMPARISON = "io.vpv.saml2.security.requested_authncontextcomparison";
	public final static String SECURITY_WANT_XML_VALIDATION = "io.vpv.saml2.security.want_xml_validation";
	public final static String SECURITY_SIGNATURE_ALGORITHM = "io.vpv.saml2.security.signature_algorithm";
	public final static String SECURITY_REJECT_UNSOLICITED_RESPONSES_WITH_INRESPONSETO = "io.vpv.saml2.security.reject_unsolicited_responses_with_inresponseto";

	// Compress
	public final static String COMPRESS_REQUEST = "io.vpv.saml2.compress.request";
	public final static String COMPRESS_RESPONSE = "io.vpv.saml2.compress.response";

	// Misc
	public final static String CONTACT_TECHNICAL_GIVEN_NAME = "io.vpv.saml2.contacts.technical.given_name";
	public final static String CONTACT_TECHNICAL_EMAIL_ADDRESS = "io.vpv.saml2.contacts.technical.email_address";
	public final static String CONTACT_SUPPORT_GIVEN_NAME = "io.vpv.saml2.contacts.support.given_name";
	public final static String CONTACT_SUPPORT_EMAIL_ADDRESS = "io.vpv.saml2.contacts.support.email_address";

	public final static String ORGANIZATION_NAME = "io.vpv.saml2.organization.name";
	public final static String ORGANIZATION_DISPLAYNAME = "io.vpv.saml2.organization.displayname";
	public final static String ORGANIZATION_URL = "io.vpv.saml2.organization.url";
	public final static String ORGANIZATION_LANG = "io.vpv.saml2.organization.lang";
	public final static String UNIQUE_ID_PREFIX_PROPERTY_KEY = "io.vpv.saml2.unique_id_prefix";

	/**
	 * Load settings from the file
	 *
	 * @param propFileName VPV SAML Settings
	 *
